Feature: Get geographical data of a country
  ...
  Scenario Outline: Get geographical data of a country that does not have info
    When method get
    Then status 200
  ...
  Scenario Outline: Get geographical data of a country with invalid latitude and longitude
    When method get
    Then status 200
